 ...
 * @author hector
 */
public class EditarProfes extends javax.swing.JFrame {

    /**
     * Creates new form EditarProfes
     */
    private Profesor editarProfesor;
    public EditarProfes(int posicion) {
        initComponents();
        editarProfesor = Login.profesores.get(posicion);
        nombrejTextField.setText(editarProfesor.nombre);
        apellidojTextField.setText(editarProfesor.apellido);
        passwordjTextField.setText(editarProfesor.contrasenia);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(apellidojTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(nombrejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void actualizarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarjButtonActionPerformed
        ...
        editarProfesor.nombre = nombrejTextField.getText();
        editarProfesor.apellido = apellidojTextField.getText();
        editarProfesor.contrasenia = passwordjTextField.getText();
